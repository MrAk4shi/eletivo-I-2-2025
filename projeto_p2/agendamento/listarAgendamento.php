...
// Consulta correta com os nomes de colunas existentes
$sql = $pdo->query("
    SELECT 
        a.idAgendamento,
        a.dataAgendamento,
...
<head>
    ...
    <link rel="stylesheet" href="listarAgendamento.css?v=<?= time() ?>">
</head>
<body>
    ...
    <table class="tabela-roxa">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="excluirAgendamento.php?id=<?= $a['idAgendamento'] ?>" 
